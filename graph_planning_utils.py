...
def get_object_centers(data, north_offset, east_offset, drone_altitude, safety_distance):
    ...
    for i in range(data.shape[0]):
        ...
        if alt + d_alt + safety_distance > drone_altitude: #if obstacle is not neglegtable due to low alt
            points.append([north - north_offset, east - east_offset]) # get obstacle coordinates
    return points;
